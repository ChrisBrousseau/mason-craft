...
/* ── Ornamental divider between degree sections ────────────────────────────── */
function DegreeDivider({ label, color, progress }) {
  return (
    <div className="degree-divider">
      <div className="degree-rule" style={{ background: `linear-gradient(90deg, transparent, ${color}30, transparent)` }} />
      ...
      <div className="degree-rule" style={{ background: `linear-gradient(90deg, transparent, ${color}30, transparent)` }} />
      <div className="degree-progress-row">
        <span className="degree-progress-text" style={{ color }}>{progress}</span>
      </div>
    </div>
  );
}
    ...
    <div className="page home-page">
      ...
      <div className="home-hero">
        ...
        <div className="home-stats">
          ...
          <div className="hstat">
            <div className="hstat-val" style={{ color: '#ff7043' }}>🔥 {streak}</div>
            <div className="hstat-lbl">Streak</div>
          </div>
          <div className="hstat-divider" />
          <div className="hstat">
            <div className="hstat-val" style={{ color: '#4caf50' }}>{completed.length}/{ALL_MODULES.length}</div>
      ...
      <div className="home-content">
        ...
        <div className="module-grid">
          {EA_MODULES.map(mod => (
            <ModuleCard
              key={mod.id}
              mod={mod}
              done={completed.includes(mod.id)}
              onClick={() => onOpen(mod)}
              accentColor="#7eb8f7"
            />
          ))}
        ...
        <div className="note-box">
          ...
          <div className="note-box-body">
            All coded words from both degrees are fully revealed throughout — BOAZ (EA), JACHIN (FC),
...
export default function App() {
  ...
  const accent = isEA ? '#7eb8f7' : '#c9a84c';
  ...
  return (
    <div className="page" style={{ paddingTop: 56, paddingBottom: 40 }}>
      ...
      <div className="lesson-body">
        ...
        {module?.type === 'tools'     && (
          <WorkingToolsLesson
            toolsData={module.toolsData}
            quizItems={module.quizItems}
            degreeLabel={module.degreeLabel}
            chargeText={module.chargeText}
