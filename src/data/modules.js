...
export const MM_MODULES = [
  ...
  { id:'mm-audio-sequence', icon:'🎧', degree:'mm', title:'MM Full Audio Sequence', sub:'Listen to the full question-and-answer sequence with pauses, and let it repeat', type:'audiosequence', xp:90, data:MM_QUESTIONS },
